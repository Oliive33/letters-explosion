// const charmingMin = require("./charming.min");
...
btnNav.addEventListener("click", () => {
  if (toggle === 0) {
    ...
    TweenMax.to(b1, 0.2, { top: 2.5, rotate: 225 });
    TweenMax.to(b3, 0.2, { top: -2.5, rotate: -225 });
    TweenMax.to(containerMenu, 0.8, { left: 0, ease: Power2.easeOut });
  } else {
    toggle--;
    TweenMax.to(b2, 0.01, { delay: 0.25, display: "block" });
    TweenMax.to(b1, 0.2, { top: -10, rotate: 0 });
    TweenMax.to(b3, 0.2, { top: 10, rotate: 0 });
